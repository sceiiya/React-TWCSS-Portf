        ...
        <main className='p-6'>
            <div className='grid grid-rows-2 gap-4'>
                <span className='flex flex-row justify-evenly gap-3'>
                    <input type="text" name="" id="" placeholder='nom' className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'/>
                    <input type="text" name="" id="" placeholder='nom' className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'/>
                </span>
